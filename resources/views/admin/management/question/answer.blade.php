                    ...
                    <div class="blog-single-content bordered blog-container">
                        <div class="blog-single-head">
                            <div class="blog-single-head-title">
                                <img src="{{asset('img/patient/'.$getQuestionById->Patient->avatar)}}" alt="" class="ava-user"> {{$getQuestionById->Patient->fullname}}
                            </div>
                        ...
                        <div class="blog-single-desc">
                            ...
                            <div class="question-pic">
                                <ul class="list-pic">
                                    <?php $questionImgs = App\QuestionImage::where('questionId', $getQuestionById->id)->get();?> @foreach($questionImgs as $img)
                        ...
                        <div class="blog-comments">
                            <h3 class="sbold blog-comments-title">
                                <i class="fa fa-comments"></i> {{count($answers)}}</h3>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body content-text">
                                        <h4 class="media-heading">
                                            ...
                                            @else
                                            <a href="">
                                                <i class="fa fa-user-md"></i> Bác sĩ {{$answer->User->fullname}}</a>
                                            @endif
                            ...
                            <div id="answerForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-1">
                                        <a href="#myModal_autocomplete" role="button" class="btn green uppercase btn-md sbold" data-toggle="modal">
...
<script>
    $(document).ready(function () {
        ...
        $('#sendAnswer').click(function () {
            ...
            urls = $('.selected-links').html().replace(' đã chọn', '').replace('selected-link',
                'selected-link-1');
        ...
        socket.on('answerSuccess', function (answer) {
            console.log('patient',answer.patient);
           if(answer.patient=='')
           {
                ...
                $('.c-comment-list').append(
                    `
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object" alt="" src="img/patient/`+answer.patient_avatar+`" > </a>
                            </div>
                            <div class="media-body content-text">
                                <h4 class="media-heading">
                                    <a href="">  ` +
        ...
        $('#addUrl').click(function () {
            ...
            $('.selected-links').append(
                `<li class="selected-link"><i class="fa fa-minus delete-url"></i><a href="{{asset('post/` +
                postId + `#service')}}" target="_blank">` + postName + `</a></li>`);
