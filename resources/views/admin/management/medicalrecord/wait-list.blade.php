                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group pull-right">
                                <a href="" id="export">
                                    <button type="button" class="btn btn-default">Xuất hóa đơn</button>
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="number" id="evening" value="0" class="form-control" style="">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group" style="margin-bottom: 10px;">
                                                ...
                                                <div class="col-md-6">
                                                    <input disabled="" type="text" value="@if($patient['DOB']) {{Carbon\Carbon::Parse($patient['DOB'])->format('d-m-Y')}} @endif"
            ...
            $.post('medicalrecord', dataSource, function (data) {
                ...
                if (data.success = 200) {
                    ...
                    $('#medicalRecord').css({
                     ...
                     $('#export').attr({
                         href: 'export-order/'+data.orderId
                     });
