                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="number" value="0" ng-change="changeQuality()" min="0" step="1" class="form-control" style="">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="number" value="0" ng-change="changeQuality()" min="0" step="1" class="form-control" ng-model="Medicine.morning"
                                                    style="">
                                            </div>
                                            <label class="col-sm-3 control-label ng-binding">Tối</label>
                                            <div class="col-sm-3">
                                                <input type="number" value="0" ng-change="changeQuality()" min="0" step="1" class="form-control" ng-model="Medicine.noon">
                                            </div>
                                        </div>
