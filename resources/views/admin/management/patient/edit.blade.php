        ...
        <form class="form-horizontal" action="{{route('editPatient',['id'=>$patient->id])}}" role="form" method="POST" enctype="multipart/form-data">
            <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        <div class="mt-checkbox-list">
                                            <label class="mt-checkbox mt-checkbox-outline">
                                                <input name="active" value="1" @if($patient->active==1) checked @endif type="checkbox">Hoạt Động
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                ...
                <legend style="margin-left:15px;">
                    <h1 class="page-title">Thông tin BHYT
                    </h1>
                </legend>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input name="cardCode" value="@if(isset($insurance[0]['id'])) {{$insurance[0]['cardCode']}} @endif" type="text" class="form-control"
                                            placeholder="  ">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy">
                                            <input name="fromdate" value="@if(isset($insurance[0]['id'])) {{Carbon\Carbon::Parse($insurance[0]['fromDate'])->format('d-m-Y')}} @endif"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input name="placeCheck" value="@if(isset($insurance[0]['id'])) {{$insurance[0]['placeCheck']}} @endif" type="text" name="insurrentcode"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy">
                                        <input name="todate" value="@if(isset($insurance[0]['id'])) {{Carbon\Carbon::Parse($insurance[0]['toDate'])->format('d-m-Y')}} @endif"
                                            type="text" class="form-control">
                                        <span class="input-group-btn">
                                            <button class="btn default" type="button">
                                                <i class="fa fa-calendar"></i>
