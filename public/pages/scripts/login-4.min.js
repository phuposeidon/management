var Login = function() {
    var e = function() {
            $(".login-form").validate({
                ...
                invalidHandler: function(e, r) {
                    $(".alert-danger", $(".login-form")).show() && setTimeout(function()
                    {
                        $('.display-hide').fadeOut();
                    },4000)
                },
    ...
    return {
        init: function() {
            e(), r(), s(), $.backstretch(["../public/pages/media/bg/1.jpg", "../public/pages/media/bg/2.jpg", "../public/pages/media/bg/3.jpg", "../public/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
